...
// on all voters during a period. This contract is for the single version. Also note, part of the reward goes to validator (unless they 
// choose to give everything to voter. )
